...
################################################################################
## Form generated from reading UI file '_mw_new.ui'
##
...
"QWidget#page_10 { background: #DCDCDC; }\n"
"QLabel { background: transparent; }\n"
"\n"
"/* ===== CARDS ===== */\n"
"QFrame#socFrame, QFrame#tempFrame, QFrame#maxCellFrame,\n"
"QFrame#speedFrame, QFrame#torqueFrame,\n"
"QFrame#brakeFrame, QFrame#throttleFrame {\n"
"    background: #FFFFFF;\n"
...
"\n"
"/* ===== TIRE TEMP ===== */\n"
"QLabel#tempFLLbl, QLabel#tempFRLbl, QLabel#tempRLLbl, QLabel#tempRRLbl {\n"
"    color: #888888;\n"
"    font-family: \"DejaVu Sans\", sans-serif;\n"
"    font-size: 11px;\n"
"    font-weight: 500;\n"
"}\n"
"QLabel#tempFL, QLabel#tempFR {\n"
"    color: #A85C06;\n"
"    font-family: \"DejaVu Sans Mono\", \"Consolas\", monospace;\n"
"    font-size: 32px;\n"
"    font-weight: 500;\n"
"}\n"
"QLabel#tempRL, QLabel#tempRR {\n"
"    color: #B0241F;\n"
"    font-family: \"DejaVu Sans Mono\", \"Consolas\", monospace;\n"
"    font-size: 32px;\n"
"    font-weight: 500;\n"
...
"    font-weight: 500;\n"
"}\n"
"QLabel#scale0, QLabel#scale15, QLabel#scale30 {\n"
"    color: #555555;\n"
...
"    font-weight: 500;\n"
"}\n"
"QLabel#torqueFLLbl, QLabel#torqueFRLbl,\n"
"QLabel#torqueRLLbl, QLabel#torqueRRLbl {\n"
"    color: #888888;\n"
"    font-family: \"DejaVu Sans\", sans-serif;\n"
"    font-size: 11px;\n"
"    font-weight: 500;\n"
"}\n"
"QLabel#torqueFL, QLabel#torqueFR,\n"
"QLabel#torqueRL, QLabel#torqueRR {\n"
"    color: #1E4ED8;\n"
"    font-family: \"DejaVu Sans Mono\", \""
                        "Consolas\", monospace;\n"
"    font-size: 22px;\n"
...
"\n"
"/* ===== PEDAL labels ===== */\n"
"QLabel#brakeLabel, QLabel#throttleLabel {\n"
"    color: #555555;\n"
"    font-family: \"DejaVu Sans\", sans-serif;\n"
"    font-size: 12px;\n"
"    font-weight: 500;\n"
...
"    border-radius: 1px;\n"
"}\n"
"QProgressBar#brakeBar::chunk { background: #B0241F; }\n"
"QProgressBar#throttleBar::chunk { background: #0C7A4F; }\n"
"QProgressBar#socBar::chunk { background: #0C7A4F; }\n"
"QProgressBar#maxCellBar::chunk { background: #0C7A4F; }\n"
"\n"
"QProgressBar#torqueBarFL, QProgressBar#torqueBarFR,\n"
"QProgressBar#torqueBarRL, QProgressBar#torqueBarRR {\n"
"    background: #CFCFCF;\n"
""
                        "    border: 1px solid rgba(0, 0, 0, 38);\n"
"    border-radius: 2px;\n"
"}\n"
"QProgressBar#torqueBarFL::chunk, QProgressBar#torqueBarFR::chunk,\n"
"QProgressBar#torqueBarRL::chunk, QProgressBar#torqueBarRR::chunk {\n"
"    background: #1E4ED8;\n"
"}")
        self.socFrame = QFrame(self.page_10)
        self.socFrame.setObjectName(u"socFrame")
        self.socFrame.setGeometry(QRect(8, 6, 754, 34))
        self.socFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.socLabel = QLabel(self.socFrame)
        self.socLabel.setObjectName(u"socLabel")
        self.socLabel.setGeometry(QRect(12, 8, 40, 18))
        self.socLabel.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.socBar = QProgressBar(self.socFrame)
        self.socBar.setObjectName(u"socBar")
        self.socBar.setGeometry(QRect(58, 10, 620, 14))
        self.socBar.setMaximum(100)
        self.socBar.setValue(68)
        self.socBar.setTextVisible(False)
        self.socValue = QLabel(self.socFrame)
        self.socValue.setObjectName(u"socValue")
        self.socValue.setGeometry(QRect(688, 6, 58, 22))
        self.socValue.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignVCenter)
        self.tempFrame = QFrame(self.page_10)
        self.tempFrame.setObjectName(u"tempFrame")
        self.tempFrame.setGeometry(QRect(8, 46, 180, 140))
        self.tempFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.tempFLLbl = QLabel(self.tempFrame)
        self.tempFLLbl.setObjectName(u"tempFLLbl")
        self.tempFLLbl.setGeometry(QRect(10, 14, 70, 14))
        self.tempFLLbl.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.tempFL = QLabel(self.tempFrame)
        self.tempFL.setObjectName(u"tempFL")
        self.tempFL.setGeometry(QRect(10, 28, 70, 42))
        self.tempFL.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.tempFRLbl = QLabel(self.tempFrame)
        self.tempFRLbl.setObjectName(u"tempFRLbl")
        self.tempFRLbl.setGeometry(QRect(100, 14, 70, 14))
        self.tempFRLbl.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.tempFR = QLabel(self.tempFrame)
        self.tempFR.setObjectName(u"tempFR")
        self.tempFR.setGeometry(QRect(100, 28, 70, 42))
        self.tempFR.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.tempRLLbl = QLabel(self.tempFrame)
        self.tempRLLbl.setObjectName(u"tempRLLbl")
        self.tempRLLbl.setGeometry(QRect(10, 78, 70, 14))
        self.tempRLLbl.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.tempRL = QLabel(self.tempFrame)
        self.tempRL.setObjectName(u"tempRL")
        self.tempRL.setGeometry(QRect(10, 92, 70, 42))
        self.tempRL.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.tempRRLbl = QLabel(self.tempFrame)
        self.tempRRLbl.setObjectName(u"tempRRLbl")
        self.tempRRLbl.setGeometry(QRect(100, 78, 70, 14))
        self.tempRRLbl.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.tempRR = QLabel(self.tempFrame)
        self.tempRR.setObjectName(u"tempRR")
        self.tempRR.setGeometry(QRect(100, 92, 70, 42))
        self.tempRR.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.maxCellFrame = QFrame(self.page_10)
        self.maxCellFrame.setObjectName(u"maxCellFrame")
        self.maxCellFrame.setGeometry(QRect(8, 192, 180, 144))
        self.maxCellFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.maxCellLabel = QLabel(self.maxCellFrame)
        self.maxCellLabel.setObjectName(u"maxCellLabel")
        self.maxCellLabel.setGeometry(QRect(12, 14, 80, 20))
        self.maxCellLabel.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.maxCellValue = QLabel(self.maxCellFrame)
        self.maxCellValue.setObjectName(u"maxCellValue")
        self.maxCellValue.setGeometry(QRect(108, 12, 60, 22))
        self.maxCellValue.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignVCenter)
        self.maxCellBar = QProgressBar(self.maxCellFrame)
        self.maxCellBar.setObjectName(u"maxCellBar")
        self.maxCellBar.setGeometry(QRect(12, 50, 156, 18))
        self.maxCellBar.setMaximum(60)
        self.maxCellBar.setValue(43)
        self.maxCellBar.setTextVisible(False)
        self.scale0 = QLabel(self.maxCellFrame)
        self.scale0.setObjectName(u"scale0")
        self.scale0.setGeometry(QRect(4, 74, 20, 14))
        self.scale0.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.scale15 = QLabel(self.maxCellFrame)
        self.scale15.setObjectName(u"scale15")
        self.scale15.setGeometry(QRect(40, 74, 20, 14))
        self.scale15.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.scale30 = QLabel(self.maxCellFrame)
        self.scale30.setObjectName(u"scale30")
        self.scale30.setGeometry(QRect(76, 74, 20, 14))
        self.scale30.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.scale45 = QLabel(self.maxCellFrame)
        self.scale45.setObjectName(u"scale45")
        self.scale45.setGeometry(QRect(112, 74, 20, 14))
        self.scale45.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.scale60 = QLabel(self.maxCellFrame)
        self.scale60.setObjectName(u"scale60")
        self.scale60.setGeometry(QRect(148, 74, 20, 14))
        self.scale60.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.scaleDQ = QLabel(self.maxCellFrame)
        self.scaleDQ.setObjectName(u"scaleDQ")
        self.scaleDQ.setGeometry(QRect(148, 92, 20, 14))
        self.scaleDQ.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.speedFrame = QFrame(self.page_10)
        self.speedFrame.setObjectName(u"speedFrame")
        self.speedFrame.setGeometry(QRect(192, 46, 386, 290))
        self.speedFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.powerValue = QLabel(self.speedFrame)
        self.powerValue.setObjectName(u"powerValue")
        self.powerValue.setGeometry(QRect(175, 20, 130, 72))
        self.powerValue.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignVCenter)
        self.powerUnit = QLabel(self.speedFrame)
        self.powerUnit.setObjectName(u"powerUnit")
        self.powerUnit.setGeometry(QRect(310, 52, 50, 30))
        self.powerUnit.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.speedValue = QLabel(self.speedFrame)
        self.speedValue.setObjectName(u"speedValue")
        self.speedValue.setGeometry(QRect(43, 96, 300, 148))
        self.speedValue.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.speedUnit = QLabel(self.speedFrame)
        self.speedUnit.setObjectName(u"speedUnit")
        self.speedUnit.setGeometry(QRect(93, 252, 200, 22))
        self.speedUnit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.torqueFrame = QFrame(self.page_10)
        self.torqueFrame.setObjectName(u"torqueFrame")
        self.torqueFrame.setGeometry(QRect(582, 46, 180, 290))
        self.torqueFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.torqueTitle = QLabel(self.torqueFrame)
        self.torqueTitle.setObjectName(u"torqueTitle")
        self.torqueTitle.setGeometry(QRect(12, 10, 70, 14))
        self.torqueTitle.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.torqueUnit = QLabel(self.torqueFrame)
        self.torqueUnit.setObjectName(u"torqueUnit")
        self.torqueUnit.setGeometry(QRect(70, 10, 98, 14))
        self.torqueUnit.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignVCenter)
        self.torqueFLLbl = QLabel(self.torqueFrame)
        self.torqueFLLbl.setObjectName(u"torqueFLLbl")
        self.torqueFLLbl.setGeometry(QRect(12, 34, 40, 14))
        self.torqueFLLbl.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.torqueBarFL = QProgressBar(self.torqueFrame)
        self.torqueBarFL.setObjectName(u"torqueBarFL")
        self.torqueBarFL.setGeometry(QRect(62, 34, 18, 108))
        self.torqueBarFL.setMaximum(100)
        self.torqueBarFL.setValue(57)
        self.torqueBarFL.setTextVisible(False)
        self.torqueBarFL.setOrientation(Qt.Orientation.Vertical)
        self.torqueFL = QLabel(self.torqueFrame)
        self.torqueFL.setObjectName(u"torqueFL")
        self.torqueFL.setGeometry(QRect(12, 110, 50, 32))
        self.torqueFL.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.torqueFRLbl = QLabel(self.torqueFrame)
        self.torqueFRLbl.setObjectName(u"torqueFRLbl")
        self.torqueFRLbl.setGeometry(QRect(96, 34, 40, 14))
        self.torqueFRLbl.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.torqueBarFR = QProgressBar(self.torqueFrame)
        self.torqueBarFR.setObjectName(u"torqueBarFR")
        self.torqueBarFR.setGeometry(QRect(148, 34, 18, 108))
        self.torqueBarFR.setMaximum(100)
        self.torqueBarFR.setValue(67)
        self.torqueBarFR.setTextVisible(False)
        self.torqueBarFR.setOrientation(Qt.Orientation.Vertical)
        self.torqueFR = QLabel(self.torqueFrame)
        self.torqueFR.setObjectName(u"torqueFR")
        self.torqueFR.setGeometry(QRect(96, 110, 50, 32))
        self.torqueFR.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.torqueRLLbl = QLabel(self.torqueFrame)
        self.torqueRLLbl.setObjectName(u"torqueRLLbl")
        self.torqueRLLbl.setGeometry(QRect(12, 156, 40, 14))
        self.torqueRLLbl.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.torqueBarRL = QProgressBar(self.torqueFrame)
        self.torqueBarRL.setObjectName(u"torqueBarRL")
        self.torqueBarRL.setGeometry(QRect(62, 156, 18, 108))
        self.torqueBarRL.setMaximum(100)
        self.torqueBarRL.setValue(81)
        self.torqueBarRL.setTextVisible(False)
        self.torqueBarRL.setOrientation(Qt.Orientation.Vertical)
        self.torqueRL = QLabel(self.torqueFrame)
        self.torqueRL.setObjectName(u"torqueRL")
        self.torqueRL.setGeometry(QRect(12, 232, 50, 32))
        self.torqueRL.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.torqueRRLbl = QLabel(self.torqueFrame)
        self.torqueRRLbl.setObjectName(u"torqueRRLbl")
        self.torqueRRLbl.setGeometry(QRect(96, 156, 40, 14))
        self.torqueRRLbl.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.torqueBarRR = QProgressBar(self.torqueFrame)
        self.torqueBarRR.setObjectName(u"torqueBarRR")
        self.torqueBarRR.setGeometry(QRect(148, 156, 18, 108))
        self.torqueBarRR.setMaximum(100)
        self.torqueBarRR.setValue(90)
        self.torqueBarRR.setTextVisible(False)
        self.torqueBarRR.setOrientation(Qt.Orientation.Vertical)
        self.torqueRR = QLabel(self.torqueFrame)
        self.torqueRR.setObjectName(u"torqueRR")
        self.torqueRR.setGeometry(QRect(96, 232, 50, 32))
        self.torqueRR.setAlignment(Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.brakeFrame = QFrame(self.page_10)
        self.brakeFrame.setObjectName(u"brakeFrame")
        self.brakeFrame.setGeometry(QRect(8, 342, 180, 72))
        self.brakeFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.brakeBar = QProgressBar(self.brakeFrame)
        self.brakeBar.setObjectName(u"brakeBar")
        self.brakeBar.setGeometry(QRect(12, 14, 156, 18))
        self.brakeBar.setMaximum(100)
        self.brakeBar.setValue(15)
        self.brakeBar.setTextVisible(False)
        self.brakeLabel = QLabel(self.brakeFrame)
        self.brakeLabel.setObjectName(u"brakeLabel")
        self.brakeLabel.setGeometry(QRect(12, 42, 156, 20))
        self.brakeLabel.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.pitFrame = QFrame(self.page_10)
        self.pitFrame.setObjectName(u"pitFrame")
        self.pitFrame.setGeometry(QRect(192, 342, 386, 72))
        self.pitFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.pitLabel = QLabel(self.pitFrame)
        self.pitLabel.setObjectName(u"pitLabel")
        self.pitLabel.setGeometry(QRect(0, 0, 386, 72))
        self.pitLabel.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.throttleFrame = QFrame(self.page_10)
        self.throttleFrame.setObjectName(u"throttleFrame")
        self.throttleFrame.setGeometry(QRect(582, 342, 180, 72))
        self.throttleFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.throttleBar = QProgressBar(self.throttleFrame)
        self.throttleBar.setObjectName(u"throttleBar")
        self.throttleBar.setGeometry(QRect(12, 14, 156, 18))
        self.throttleBar.setMaximum(100)
        self.throttleBar.setValue(75)
        self.throttleBar.setTextVisible(False)
        self.throttleLabel = QLabel(self.throttleFrame)
        self.throttleLabel.setObjectName(u"throttleLabel")
        self.throttleLabel.setGeometry(QRect(12, 42, 156, 20))
...
"Motor Temp", None))
        ...
        self.socLabel.setText(QCoreApplication.translate("MainWindow", u"SOC", None))
        self.socValue.setText(QCoreApplication.translate("MainWindow", u"68%", None))
        self.tempFLLbl.setText(QCoreApplication.translate("MainWindow", u"FL", None))
        self.tempFL.setText(QCoreApplication.translate("MainWindow", u"84", None))
        self.tempFRLbl.setText(QCoreApplication.translate("MainWindow", u"FR", None))
        self.tempFR.setText(QCoreApplication.translate("MainWindow", u"82", None))
        self.tempRLLbl.setText(QCoreApplication.translate("MainWindow", u"RL", None))
        self.tempRL.setText(QCoreApplication.translate("MainWindow", u"91", None))
        self.tempRRLbl.setText(QCoreApplication.translate("MainWindow", u"RR", None))
        self.tempRR.setText(QCoreApplication.translate("MainWindow", u"93", None))
        self.maxCellLabel.setText(QCoreApplication.translate("MainWindow", u"MAX CELL", None))
        self.maxCellValue.setText(QCoreApplication.translate("MainWindow", u"43\u00b0", None))
        self.scale0.setText(QCoreApplication.translate("MainWindow", u"0", None))
        self.scale15.setText(QCoreApplication.translate("MainWindow", u"15", None))
        self.scale30.setText(QCoreApplication.translate("MainWindow", u"30", None))
        self.scale45.setText(QCoreApplication.translate("MainWindow", u"45", None))
        self.scale60.setText(QCoreApplication.translate("MainWindow", u"60", None))
        self.scaleDQ.setText(QCoreApplication.translate("MainWindow", u"DQ", None))
        self.powerValue.setText(QCoreApplication.translate("MainWindow", u"47", None))
        self.powerUnit.setText(QCoreApplication.translate("MainWindow", u"kW", None))
        ...
        self.torqueTitle.setText(QCoreApplication.translate("MainWindow", u"TORQUE", None))
        self.torqueUnit.setText(QCoreApplication.translate("MainWindow", u"Nm \u00b7 max 21", None))
        self.torqueFLLbl.setText(QCoreApplication.translate("MainWindow", u"FL", None))
        self.torqueFL.setText(QCoreApplication.translate("MainWindow", u"12", None))
        self.torqueFRLbl.setText(QCoreApplication.translate("MainWindow", u"FR", None))
        self.torqueFR.setText(QCoreApplication.translate("MainWindow", u"14", None))
        self.torqueRLLbl.setText(QCoreApplication.translate("MainWindow", u"RL", None))
        self.torqueRL.setText(QCoreApplication.translate("MainWindow", u"17", None))
        self.torqueRRLbl.setText(QCoreApplication.translate("MainWindow", u"RR", None))
        self.torqueRR.setText(QCoreApplication.translate("MainWindow", u"19", None))
        self.brakeLabel.setText(QCoreApplication.translate("MainWindow", u"BRAKE", None))
        self.pitLabel.setText(QCoreApplication.translate("MainWindow", u"PIT MODE", None))
